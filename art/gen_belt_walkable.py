#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Regenerate area_belt walkable from explicit prop footprints."""
...
def main() -> None:
    ...
    chapter = next(c for c in data["chapters"] if c["id"] == "area_belt")
    room = chapter["room"]
    ...
    print(f"updated area_belt walkable {cols}x{rows}")
