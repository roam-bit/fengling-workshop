#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Regenerate area_edge walkable from fog locks and prop footprints."""
...
def main() -> None:
    ...
    chapter = next(c for c in data["chapters"] if c["id"] == "area_edge")
    room = chapter["room"]
    ...
    print(f"updated area_edge walkable {cols}x{rows}")
